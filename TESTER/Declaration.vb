Module Declaration
    ...
    Public ADDR_ST2_MEASUREMENT As Integer = 7200
    Public ADDR_ST3_RESISTANCE As Integer = 0
    Public ADDR_ST4_P2_TRAVEL As Integer = 7202
    Public ADDR_ST4_P3_TRAVEL As Integer = 7204
    Public ADDR_DIFF_STR_RESULT As Integer = 7206
    ...
    Public ADDR_ACT_VAL As Integer = 7000
    Public ADDR_ACT_VAL_TOL As Integer = 7002
    Public ADDR_DIF_STR As Integer = 7004
    Public ADDR_DIF_STR_TOL As Integer = 7006
    Public ADDR_BEATING_TIMES As Integer = 7008
